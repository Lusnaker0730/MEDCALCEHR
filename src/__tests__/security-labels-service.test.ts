...
describe('SecurityLabelsService', () => {
    let service: SecurityLabelsService;
    ...
    describe('User Authorization', () => {
        const authorizedUser: UserAuthorization = {
            userId: 'user-123',
        ...
        it('should mask data for unauthorized user', () => {
            const unauthorizedUser: UserAuthorization = {
                userId: 'user-456',
                roles: ['nurse'],
    ...
    describe('addSecurityLabel', () => {
        ...
        it('should replace existing confidentiality label', () => {
            ...
            const confLabels = updated.meta?.security?.filter(
