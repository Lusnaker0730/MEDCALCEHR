...
describe('FHIRFeedback', () => {
    ...
    describe('injectStyles', () => {
        test('should inject a link element into document.head on first call', () => {
            ...
            const link = document.getElementById('fhir-feedback-styles') as HTMLLinkElement;
            expect(link).not.toBeNull();
    ...
    describe('showSuccess', () => {
        ...
        test('should auto-remove after 5000ms', () => {
            ...
            let indicator = document.querySelector('.fhir-feedback-indicator') as HTMLElement;
            expect(indicator).not.toBeNull();
            ...
            indicator = document.querySelector('.fhir-feedback-indicator') as HTMLElement;
    ...
    describe('createDataSummary', () => {
        test('should create a success summary when all data is loaded', () => {
            const summary: DataLoadingSummary = {
    ...
    describe('trackDataLoading', () => {
        test('should track resolved promises with setValue and mark as loaded', async () => {
            ...
            const setValueMock = jest.fn((i: HTMLInputElement, d: any) => {
                i.value = String(d);
            }) as jest.Mock<any>;
            ...
            const fields: DataFieldSpec[] = [
                {
                    ...
                    setValue: jest.fn() as jest.Mock<any>
                }
            ];
    ...
    describe('dynamic summary updates', () => {
        ...
        test('should handle updateSummaryBannerState with remaining missing fields', () => {
            ...
            const details = summary?.querySelectorAll('.details') as NodeListOf<HTMLElement>;
            details?.forEach(d => {
        ...
        test('should not auto-hide if summary class changed away from success before timeout', () => {
            ...
            jest.advanceTimersByTime(3000);
            expect((summary as HTMLElement)?.style.opacity).not.toBe('0');
