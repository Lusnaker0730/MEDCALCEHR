...
describe('SEX-SHOCK Calculator', () => {
    ...
    describe('Standard Calculations - Female', () => {
        ...
        test('Low risk female', () => {
            ...
            expect(parseFloat(result![0].value as string)).toBeLessThan(1.0);
        ...
        test('High risk female', () => {
            ...
            expect(result).not.toBeNull();
            expect(parseFloat(result![0].value as string)).toBeGreaterThan(30);
    ...
    describe('Variable Transforms', () => {
        test('CRP logarithmic transform', () => {
            ...
            const scoreNo = parseFloat(noCRP![0].value as string);
            const scoreYes = parseFloat(withCRP![0].value as string);
