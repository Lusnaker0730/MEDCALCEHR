...
beforeEach(() => {
    jest.spyOn(console, 'debug').mockImplementation(mockConsoleDebug as any);
    jest.spyOn(console, 'log').mockImplementation(mockConsoleLog as any);
    jest.spyOn(console, 'warn').mockImplementation(mockConsoleWarn as any);
    jest.spyOn(console, 'error').mockImplementation(mockConsoleError as any);
});
...
function createEntry(level: string = 'ERROR', message: string = 'test'): LogEntry {
    return {
