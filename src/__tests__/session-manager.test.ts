 ...
 */
function simulateActivity(eventName: string) {
...
describe('SessionManager', () => {
    ...
    describe('Focus trapping', () => {
        ...
        test('should trap Tab forward from last button to first button', () => {
            ...
            const overlay = document.getElementById('session-timeout-overlay')!;
            const logoutBtn = document.getElementById('session-logout-btn') as HTMLElement;
        ...
        test('should trap Shift+Tab from first button to last button', () => {
            ...
            const overlay = document.getElementById('session-timeout-overlay')!;
            const continueBtn = document.getElementById('session-continue-btn') as HTMLElement;
