        ...
        if (client) {
            ...
            fhirDataService.getObservation(LOINC_CODES.TEMPERATURE, {
                ...
                if (result.value !== null) {
                    if (el) el.textContent = `${result.value.toFixed(1)} °C`;
            ...
            fhirDataService.getObservation(LOINC_CODES.HEART_RATE, {
                ...
                if (result.value !== null) {
                    if (el) el.textContent = `${result.value.toFixed(0)} bpm`;
                    if (result.value > 90) {
            ...
            fhirDataService.getObservation(LOINC_CODES.RESPIRATORY_RATE, {
                ...
                if (result.value !== null) {
                    if (el) el.textContent = `${result.value.toFixed(0)} /min`;
                    if (result.value > 20) {
            ...
            fhirDataService.getObservation(LOINC_CODES.WBC, {
                ...
                if (result.value !== null) {
                    ...
                    if (el) el.textContent = `${result.value} ${unit}`;
