...
export const nafldFibrosisScore: CalculatorModule = {
    ...
    initialize: function (client, patient, container) {
        ...
        const calculate = () => {
            ...
            const diabetesInput = container.querySelector('input[name="nafld-diabetes"]:checked') as HTMLInputElement;
            ...
            try {
                ...
                if (!validation.isValid) {
                    ...
                    if (hasInput) {
                        const valuesPresent = !isNaN(age) && !isNaN(bmi) && !isNaN(ast) && !isNaN(alt) && (platelet !== null && !isNaN(platelet)) && (albumin !== null && !isNaN(albumin));
                ...
                if (platelet === null || albumin === null) return;
                ...
                logError(error as Error, { calculator: 'nafld-fibrosis-score', action: 'calculate' });
