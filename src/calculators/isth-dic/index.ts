...
export const isthDic: CalculatorModule = {
    id: 'isth-dic',
    ...
    initialize: function (client, patient, container) {
        ...
        const setRadioFromValue = (groupName: string, value: number | null, ranges: Array<{ condition: (v: number) => boolean; value: string }>) => {
        ...
        if (ptInput) ptInput.addEventListener('input', function () {
