...
export const pediatricBP = createUnifiedFormulaCalculator({
    ...
    formulaSection: {
        ...
        scoringCriteria: [
            ...
            { criteria: 'Elevated BP', points: 'SBP or DBP ≥90th to <95th percentile, or 120/80 to <95th' },
            { criteria: 'Stage 1 HTN', points: 'SBP or DBP ≥95th to <95th+12 mmHg, or 130-139/80-89' },
    ...
    reference: `
        ...
        content: uiBuilder.createTable({
            ...
            rows: [
                ...
                ['Stage 1 HTN', 'Lifestyle changes; Recheck in 1-2 weeks; If persistent, refer'],
                ['Stage 2 HTN', 'Refer to specialist within 1 week (or immediately if symptomatic)']
            ]
        })
    })}
