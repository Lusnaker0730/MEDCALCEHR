...
const conversionMatrix: ConversionMatrix = {
    ...
    diazepam: {
        ...
        oxazepam: { factor: 2, range: [0.5, 4] },
        temazepam: { factor: 2, range: [0.5, 4] },
        triazolam: { factor: 1 / 20, range: [1 / 40, 1 / 10] }
    },
    clonazepam: {
        alprazolam: { factor: 0.5, range: [0.5, 4] },
    ...
    lorazepam: {
        alprazolam: { factor: 0.5, range: [1, 4] },
    ...
    oxazepam: {
        ...
        diazepam: { factor: 0.5, range: [0.5, 4] },
