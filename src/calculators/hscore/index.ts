...
export const hscore: CalculatorModule = {
    ...
    initialize: function (client, patient, container) {
                    ...
                    if (resultContent) {
                        resultContent.innerHTML = `
                            ...
                            ${uiBuilder.createAlert({
                                type: 'info',
                                message:
                                    'Best cutoff value was 169, corresponding to sensitivity of 93% and specificity of 86%.'
                            })}
                        `;
                    }
        ...
        if (client) {
            ...
            fhirDataService
                .getObservation('2276-4', { trackStaleness: true, stalenessLabel: 'Ferritin' })
                .then(result => {
                    if (result.value !== null) {
            ...
            // Triglycerides
            fhirDataService
                .getObservation(LOINC_CODES.TRIGLYCERIDES, {
                    trackStaleness: true,
            ...
            // AST
            fhirDataService
                .getObservation(LOINC_CODES.AST, { trackStaleness: true, stalenessLabel: 'AST' })
                .then(result => {
                    if (result.value !== null) {
