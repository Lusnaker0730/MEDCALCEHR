    ...
    initialize: function (client, patient, container) {
        ...
        if (client) {
            Promise.all([
                ...
                if (wbc && wbc.valueQuantity && wbc.valueQuantity.value <= 5) cytopeniaCount++; // Assuming K/uL or similar scale
                if (platelets && platelets.valueQuantity && platelets.valueQuantity.value <= 110) cytopeniaCount++; // Assuming K/uL or similar scale
