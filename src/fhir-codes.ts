...
export const LOINC_CODES: Record<string, string> = {
    // Vital Signs
    VITAL_SIGNS_PANEL: '85353-1', //ok Vital signs, weight, height, head circumference, oxygen saturation, and BMI panel
    SYSTOLIC_BP: '8480-6', //ok Systolic blood pressure
    DIASTOLIC_BP: '8462-4', //ok Diastolic blood pressure
    /** Blood pressure panel — comma = FHIR OR search (85354-9 panel | 55284-4 systolic+diastolic) */
    BP_PANEL: '85354-9', //ok Blood pressure panel with all children optional
    MEAN_BP: '8478-0', //ok Mean blood pressure
    ...
    // Body Measurements
    HEIGHT: '8302-2', //ok Body height
    WEIGHT: '29463-7', //ok Body weight
    BMI: '39156-5', //ok Body mass index
    HEAD_CIRCUMFERENCE: '9843-4', // Head circumference

    // Pediatric Measurements
    PEDIATRIC_BMI_FOR_AGE: '59576-9', //ok Pediatric BMI for age percentile
    PEDIATRIC_WEIGHT_FOR_HEIGHT: '77606-2', //ok Pediatric weight for height percentile
    PEDIATRIC_HEAD_CIRCUMFERENCE: '8289-1', //ok Pediatric head circumference percentile

    // Laboratory - Hematology
    HEMOGLOBIN: '718-7', //ok Hemoglobin
    ...
    FASTING_GLUCOSE: '1558-6', // Fasting Glucose
    ...
    D_DIMER: '48067-3', // D-dimer

    // Laboratory - Arterial Blood Gas
    PH: '2744-1', // pH
    PCO2: '2019-8', // pCO2
    PO2: '2703-7', // pO2
    PaO2_FiO2: '50982-8', // PaO2/FiO2 ratio
    ...
    ETHANOL: '5643-2', // Ethanol concentration
...
export function getMeasurementType(code: string): string {
    ...
    const codeMap: Record<string, string> = {
        ...
        // Circumference
        [LOINC_CODES.HEAD_CIRCUMFERENCE]: 'circumference' // Head circumference
    };
