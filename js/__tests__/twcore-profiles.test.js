...
import { TW_OBSERVATION_PROFILES, getTWCoreObservationProfile, isVitalSignCode, getTWCoreObservationCategory, } from '../twcore/observation-profiles.js';
...
describe('TW Core Profiles', () => {
    ...
    describe('TW_OBSERVATION_PROFILES', () => {
        ...
        test('should include laboratoryResult profile', () => {
            expect(TW_OBSERVATION_PROFILES.laboratoryResult).toBe(`${TW_CORE_BASE}/Observation-laboratoryResult-twcore`);
        });
        test('should include vitalSigns profile', () => {
            expect(TW_OBSERVATION_PROFILES.vitalSigns).toBe(`${TW_CORE_BASE}/Observation-vitalSigns-twcore`);
        });
        test('should include bloodPressure profile', () => {
            expect(TW_OBSERVATION_PROFILES.bloodPressure).toBe(`${TW_CORE_BASE}/Observation-bloodPressure-twcore`);
        });
        test('should include bmi profile', () => {
            expect(TW_OBSERVATION_PROFILES.bmi).toBe(`${TW_CORE_BASE}/Observation-bmi-twcore`);
        });
    });
