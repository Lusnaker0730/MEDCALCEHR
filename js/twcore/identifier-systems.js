 ...
 */
export function isTWCoreIdentifierSystem(system) {
    return Object.values(TW_IDENTIFIER_SYSTEMS).includes(system);
}
/**
 * Get the identifier type label for a given system URL
 */
export function getIdentifierTypeLabel(system) {
    switch (system) {
