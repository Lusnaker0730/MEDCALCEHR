...
export const fena: Calculator = {
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const resultBox = container.querySelector('#fena-result') as HTMLElement;
        ...
        const calculateAndUpdate = () => {
            ...
            const uCrInput = container.querySelector('#fena-urine-creat') as HTMLInputElement;
            const sCrInput = container.querySelector('#fena-serum-creat') as HTMLInputElement;
        ...
        if (client) {
            Promise.all([
                ...
                uNaInput.dispatchEvent(new Event('input'));
            });
        }
    }
};
