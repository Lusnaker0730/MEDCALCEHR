...
export const wellsPE: CalculatorModule = {
    id: 'wells-pe',
    ...
    generateHTML: function () {
        ...
        return `
            ...
            type: 'info',
            message: 'Check all criteria that apply to the patient. Score interpretation helps guide D-dimer testing and CT angiography decisions.'
        })}
    ...
    initialize: function (client: any, patient: any, container: HTMLElement) {
        ...
        const calculate = () => {
            try {
                ...
                const errorContainer = container.querySelector('#wells-pe-error-container') as HTMLElement;
                if (errorContainer) {
                    displayError(errorContainer, error as Error);
                } else {
                    console.error(error);
                }
                logError(error as Error, { calculator: 'wells-pe', action: 'calculate' });
            }
        };
