...
export const mme: Calculator = {
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const addBtn = container.querySelector('#add-opioid-btn') as HTMLButtonElement;
        const resultBox = container.querySelector('#mme-result') as HTMLElement;
