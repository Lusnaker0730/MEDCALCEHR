        ...
        return `
            ...
            <div class="section">
                ...
                <div class="input-group">
                    ...
                    ${createUnitSelector('mdrd-creatinine', 'creatinine', ['mg/dL', 'Âµmol/L'], 'mg/dL')}
                </div>
            </div>
            ...
            <div class="formula-section">
                ...
                <div class="formula-item">
                    ...
                    <div class="formula">
                        ...
                        Result = estimated GFR in mL/min/1.73mÂ²
                    </div>
                </div>
                <div class="formula-item">
            ...
            if (creatinineMgDl > 0 && age > 0) {
                ...
                resultEl.innerHTML = `
                    ...
                    <div class="result-score">
                        ...
                        <span class="result-score-unit">mL/min/1.73mÂ²</span>
                    </div>
                    ...
                    <div class="alert ${alertType} mt-20">
                        <span class="alert-icon">${alertType === 'warning' ? '? ï?' : '?¹ï?'}</span>
                        <div class="alert-content">
                            <p>${alertMsg}</p>
                        </div>
                    </div>
