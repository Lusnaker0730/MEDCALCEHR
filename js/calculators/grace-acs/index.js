    ...
    initialize: function (client, patient, container) {
        ...
        const calculate = () => {
            try {
                ...
                if (!ageInput || !hrInput || !sbpInput || !creatinineInput)
                    return;
                ...
                if (validCreatinine >= 0 && validCreatinine <= 0.39)
                    crPoints = 1;
                else if (validCreatinine >= 0.4 && validCreatinine <= 0.79)
                    crPoints = 4;
                else if (validCreatinine >= 0.8 && validCreatinine <= 1.19)
                    crPoints = 7;
                else if (validCreatinine >= 1.2 && validCreatinine <= 1.59)
                    crPoints = 10;
                else if (validCreatinine >= 1.6 && validCreatinine <= 1.99)
                    crPoints = 13;
                else if (validCreatinine >= 2.0 && validCreatinine <= 3.99)
                    crPoints = 21;
                else if (validCreatinine >= 4.0)
                    crPoints = 28;
        ...
        if (client) {
            ...
            const fetchHR = async () => {
                ...
                try {
                    ...
                    console.error('Error fetching HR standalone', e);
                }
                ...
                if (hrValue === null) {
                    try {
                        ...
                        console.error('Error fetching HR from Panel', e);
                    }
                }
                if (hrValue !== null) {
                    const hrInput = container.querySelector('#grace-hr');
            ...
            const fetchSBP = async () => {
                ...
                try {
                    ...
                    console.error('Error fetching SBP standalone', e);
                }
                ...
                if (sbpValue === null) {
                    try {
                        ...
                        console.error('Error fetching BP Panel', e);
                    }
                }
                // Update UI
                if (sbpValue !== null) {
            ...
            getMostRecentObservation(client, LOINC_CODES.CREATININE).then(obs => {
                if (obs?.valueQuantity) {
                    ...
                    const crInput = container.querySelector('#grace-creatinine');
                    if (crInput) {
