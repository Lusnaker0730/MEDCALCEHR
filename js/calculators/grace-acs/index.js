...
const config = {
    ...
    calculate: (values) => {
        const age = values['grace-age'];
        const hr = values['grace-hr'];
        const sbp = values['grace-sbp'];
        const creatinine = values['grace-creatinine'];
        ...
        if (creatinine >= 0 && creatinine <= 0.39)
            ...
            crPoints = 28;
        // Radio points
        const killip = parseInt(values['grace-killip'] || '0');
        const arrest = parseInt(values['grace-cardiac-arrest'] || '0');
        const st = parseInt(values['grace-st-deviation'] || '0');
        const enzymes = parseInt(values['grace-cardiac-enzymes'] || '0');
