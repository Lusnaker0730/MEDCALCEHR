...
export const hasBled = {
    ...
    initialize: async function (client: any, patient: any, container: HTMLElement): Promise<void> {
        ...
        const calculate = () => {
            try {
                ...
                const resultBox = container.querySelector('#has-bled-result') as HTMLElement;
                ...
                const errorContainer = container.querySelector('#hasbled-error-container') as HTMLElement;
                if (errorContainer) {
        ...
        if (client) {
            try {
                ...
                // Conditions
                getPatientConditions(client, ['38341003', '80294001', '19943007', '230690007', '131148009']).then(conditions => {
                    if (conditions) {
