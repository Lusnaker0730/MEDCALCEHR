...
// Interfaces for conversion data
interface ConversionData {
    factor: number;
    range: [number, number];
}

interface DrugConversions {
    [targetDrug: string]: ConversionData;
}

interface ConversionTable {
    [sourceDrug: string]: DrugConversions;
}
...
export const benzoConversion: CalculatorModule = {
    id: 'benzo-conversion',
