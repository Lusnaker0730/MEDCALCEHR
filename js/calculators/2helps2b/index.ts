...
export const helps2bScore: Calculator = {
    id: '2helps2b',
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const calculate = () => {
            ...
            // Risk mapping
            const riskData: Record<number, { risk: string; category: string; alertType: string }> = {
            ...
            const resultBox = container.querySelector('#helps2b-result') as HTMLElement;
