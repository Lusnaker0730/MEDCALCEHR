...
export const nafldFibrosisScore = {
    ...
    generateHTML: function () {
        return `
            ...
            <div class="input-group">
                <label for="nafld-bmi">BMI (kg/mÂ²)</label>
            ...
            <div class="formula-section">
                ...
                <div style="background: #e8f4fd; padding: 15px; border-radius: 8px; border-left: 4px solid #2196F3;">
                    <h5 style="margin-top: 0; color: #0c5460;">? ï? Risk Factors for NAFLD Progression:</h5>
                    <ul style="margin: 10px 0; padding-left: 20px; font-size: 0.85em; color: #0c5460;">
                        <li>Obesity (BMI ??30 kg/mÂ²)</li>
    ...
    initialize: function (client, patient, container) {
        ...
        if (client) {
            ...
            getMostRecentObservation(client, LOINC_CODES.AST)
                .then(obs => {
                    // AST
                    if (obs && obs.valueQuantity) {
            ...
            getMostRecentObservation(client, LOINC_CODES.ALT)
                .then(obs => {
                    // ALT
                    if (obs && obs.valueQuantity) {
            ...
            getMostRecentObservation(client, LOINC_CODES.PLATELETS)
                .then(obs => {
                    // Platelet
                    if (obs && obs.valueQuantity) {
