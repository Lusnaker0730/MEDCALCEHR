 ...
 */
export function calculatePCE(patient) {
 ...
 */
export const ascvdCalculationPure = (values) => {
    // 1. Check Known ASCVD
    ...
    const smokerStatus = (values['ascvd-smoker'] || 'never');
 ...
 */
export function getAspirinRecommendation(patient, tenYearRisk) {
    ...
    if (patient.age >= 60) {
        return {
            ...
            rationale: 'For adults ≥60 years, initiating aspirin for primary prevention is NOT recommended (2022 USPSTF). Bleeding risk outweighs cardiovascular benefit.',
            alertClass: 'danger'
        };
    }
    // Age 40-59
    if (tenYearRisk >= 10) {
        return {
            ...
            rationale: 'For adults 40-59 years with 10-year ASCVD risk ≥10%, low-dose aspirin (81 mg/day) may be considered. ' +
    ...
    return {
        recommendation: 'not-recommended',
        title: 'Aspirin: Not Recommended',
        rationale: 'For adults 40-59 years with 10-year ASCVD risk <10%, initiating aspirin for primary prevention is not recommended. ' +
 ...
 */
export function getCACGuidance(tenYearRisk) {
    if (tenYearRisk < 5) {
    ...
    if (tenYearRisk < 7.5) {
        ...
        return {
            ...
            guidance: 'In borderline-risk patients (5–7.4%), CAC score is the most evidence-based tool to reclassify risk and guide statin decisions.',
            interpretation: '• CAC = 0 → Risk is lower than expected; statin initiation may be deferred\n' +
    ...
    if (tenYearRisk < 20) {
        ...
        return {
            ...
            guidance: 'In intermediate-risk patients (7.5–19.9%), a CAC score is reasonable if the patient or clinician remains uncertain about initiating statin therapy after a risk discussion.',
            interpretation: '• CAC = 0 → Statin may be withheld; reassess in 5–10 years\n' +
