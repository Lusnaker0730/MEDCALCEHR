...
export const ariscat: Calculator = {
    id: 'ariscat',
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const calculate = () => {
            ...
            const resultBox = container.querySelector('#ariscat-result') as HTMLElement;
        ...
        if (patient && patient.birthDate) {
            ...
            const ageRadio = container.querySelector(`input[name="ariscat-age"][value="${ageValue}"]`) as HTMLInputElement;
            if (ageRadio) {
