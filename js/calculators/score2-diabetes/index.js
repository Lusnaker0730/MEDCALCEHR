...
export const score2Diabetes = {
            ...
            <div class="form-container modern">
                 ...
                 <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-age">
                        <span>years</span>
                    </div>
                </div>
                <div class="input-row">
                 ...
                 <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-sbp" placeholder="Norm: 100 - 120">
                        <span>mm Hg</span>
                    </div>
                </div>
                <div class="input-row">
                ...
                <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-tchol" placeholder="Norm: 150 - 200">
                        <span>mg/dL</span>
                    </div>
                </div>
                 <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-hdl" placeholder="Norm: 60 - 155">
                        <span>mg/dL</span>
                    </div>
                </div>
                <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-hba1c" placeholder="Norm: 4.0 - 5.6">
                        <span>%</span>
                    </div>
                </div>
                 <div class="input-row">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="score2d-egfr" placeholder="Norm: 90 - 120">
    ...
    initialize: function(client, patient, container) {
        ...
        const calculate = () => {
            const allFilled = Object.values(fields).every(el => {
                // For getters, the property itself is the element
        ...
        getMostRecentObservation(client, '2093-3').then(obs => { if (obs && obs.valueQuantity) fields.tchol.value = obs.valueQuantity.value.toFixed(0); calculate(); });
        getMostRecentObservation(client, '2085-9').then(obs => { if (obs && obs.valueQuantity) fields.hdl.value = obs.valueQuantity.value.toFixed(0); calculate(); });
        getMostRecentObservation(client, '4548-4').then(obs => { if (obs && obs.valueQuantity) fields.hba1c.value = obs.valueQuantity.value.toFixed(1); calculate(); });
