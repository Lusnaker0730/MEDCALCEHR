...
export const fourPeps: Calculator = {
    id: '4peps',
    ...
    initialize: async (client: FHIRClient, patient: Patient, container: HTMLElement): Promise<void> => {
        ...
        const calculate = () => {
            ...
            radioGroups.forEach(id => {
                const checked = container.querySelector(`input[name="4peps-${id}"]:checked`) as HTMLInputElement;
                if (checked) {
            ...
            const resultBox = container.querySelector('#fourpeps-result') as HTMLElement;
        ...
        try {
            if (patient) {
                ...
                if (patient.gender) {
                    ...
                    const radio = container.querySelector(`input[name="4peps-sex"][value="${genderVal}"]`) as HTMLInputElement;
