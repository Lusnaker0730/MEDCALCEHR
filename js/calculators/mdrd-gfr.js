...
export const mdrdGfr = {
    ...
    initialize: function(client, patient) {
        const creatinineInput = document.getElementById('mdrd-creatinine');
        const ageInput = document.getElementById('mdrd-age');
        const genderSelect = document.getElementById('mdrd-gender');
        ...
        document.getElementById('calculate-mdrd').addEventListener('click', () => {
            const creatinine = parseFloat(creatinineInput.value);
            const age = parseFloat(ageInput.value);
            const isFemale = document.getElementById('mdrd-gender').value === 'female';
            const isAA = document.getElementById('mdrd-race').value === 'aa';
