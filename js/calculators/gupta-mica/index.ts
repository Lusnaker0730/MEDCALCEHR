...
export const guptaMica: Calculator = {
    id: 'gupta-mica',
    ...
    initialize: function (client: FHIRClient | null, patient: Patient | null, container: HTMLElement): void {
        ...
        const statusSelect = container.querySelector('#mica-status') as HTMLSelectElement;
        const asaSelect = container.querySelector('#mica-asa') as HTMLSelectElement;
        const creatInput = container.querySelector('#mica-creat') as HTMLInputElement;
        const procedureSelect = container.querySelector('#mica-procedure') as HTMLSelectElement;
        const resultEl = container.querySelector('#mica-result') as HTMLElement;
        ...
        if (patient && patient.birthDate) {
            ...
            if (age > 0) ageInput.value = age.toString();
        }
