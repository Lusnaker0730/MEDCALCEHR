...
export const bwps: Calculator = {
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const calculate = () => {
            ...
            const resultBox = container.querySelector('#bwps-result') as HTMLElement;
        ...
        fields.forEach(id => {
            (container.querySelector(`#bwps-${id}`) as HTMLElement).addEventListener('change', calculate);
        });
