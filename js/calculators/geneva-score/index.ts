...
export const genevaScore: Calculator = {
    id: 'geneva-score',
    ...
    initialize: function (client: FHIRClient, patient: Patient, container: HTMLElement): void {
        ...
        const calculate = () => {
            ...
            checkedBoxes.forEach(box => {
                score += parseInt((box as HTMLInputElement).value, 10);
            });
            ...
            const resultBox = container.querySelector('#geneva-result') as HTMLElement;
            if (!hrInput || isNaN(hr)) {
