        ...
        return `
            ...
            <div class="formula-section">
                ...
                <div class="correction-rationale">
                    <h5>?зм Why Correction is Needed</h5>
    ...
    initialize: function (client, patient, container) {
        ...
        const calculateAndUpdate = () => {
            ...
            resultEl.innerHTML = `
                ...
                ${correctedPhenytoin > 20 ? '<div style="background: #ffebee; padding: 12px; border-radius: 6px; margin-top: 10px; font-size: 0.9em;"><strong>?ая? Note:</strong> Levels >20 mcg/mL may be associated with toxicity. Consider clinical correlation and dose adjustment.</div>' : ''}
            `;
